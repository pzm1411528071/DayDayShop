...
<script type="text/javascript">
	...
	function delCategory(cid){//通过传参传入,不能直接通过el表达式
		if(confirm("您是否要删除该商品分类!!")){
			location.href="${pageContext.request.contextPath }/adminDelCategoryByCid?cid="+cid;
		}
	}
</script>
</head>
						...
						<c:forEach items="${categoryList}" var="category" varStatus="vs">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px">
								    <a href="${pageContext.request.contextPath }/admin/category/edit.jsp?cname=${category.cname}">
									<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
								    </a>
								</td>
								<td align="center" style="HEIGHT: 22px">
								    <a href="javascript:;" onclick="delCategory('${category.cid}')" id="delete" class="delete">
