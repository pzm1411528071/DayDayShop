...
<!DOCTYPE html>
<!-- 登录 注册 购物车... -->
<!-- container-fluid是bootstrap.min.css定义好的容器 -->
<div class="container-fluid">
	<div class="col-md-4">
		<img src="images/background/logo2.png" width="400px" height="65px" />
	</div>
	<div class="col-md-5">
		<img src="images/background/header.png" />
	</div>
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<li><a href="${pageContext.request.contextPath }/productMyOrders">我的订单</a></li>
		</ol>
	</div>
</div>
...
<div class="container-fluid">
    ...
    <!-- nav是bootstrap.min.css定义好的组件里的导航条 -->
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath }/productIndex">首页</a>
			</div>
			        ...
			        $(function(){
				        ...
				        $.post(
					        ...
					        function(data){
						        ...
						        $("#categoryUl").html(content); //将拼接好的li放置到ul中
					        },
					        "json"
				        );
			        });
